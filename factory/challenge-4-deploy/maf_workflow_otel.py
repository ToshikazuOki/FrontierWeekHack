...
# ---------------------------------------------------------
# 5. マルチエージェント オーケストレーション (Workflow)
# ---------------------------------------------------------
async def run_factory_pipeline():
    # トレースの親スパン（Span）を作成
    tracer = trace.get_tracer(__name__)
    with tracer.start_as_current_span("run_factory_pipeline_workflow"):
